    ...
    <body class="page-header-fixed">
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                <div class="profile"><img src="../assets/images/${urlname=="/admin"?"admin.png":"client.png"}" width="52" alt="David Green"/><span></span></div>
                               ...
                               <!--  <li class="dropdown">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        ...
                                        <img class="img-circle avatar" src="../assets/images/${urlname=="/admin"?"admin.png":"client.png"}" width="40" height="40" alt="">
                                    </a>
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                <div class="sidebar-profile-image">
                                    <img src="../assets/images/${urlname=="/admin"?"admin.png":"client.png"}"   class="img-circle img-responsive" alt="">
                                </div>
...
<!--                             <ul class="sub-menu">
                        ...
                        <li id="chartActive" class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-stats"></span><p>차트</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
